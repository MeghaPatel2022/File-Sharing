...
import com.bbot.copydata.xender.filter.loader.ApkLoader;
import com.bbot.copydata.xender.filter.loader.AudioLoader;
import com.bbot.copydata.xender.filter.loader.ImageLoader;
import com.bbot.copydata.xender.filter.loader.VideoLoader;
...
public class ApkfilecallBack implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private ApkResultCallback resultCallback;
    ...
    public ApkfilecallBack(Context context, ApkResultCallback resultCallback, int type, String[] suffixArgs) {
        this.context = new WeakReference<>(context);
        this.resultCallback = resultCallback;
        this.mType = type;
        suffixArgs = new String[]{"apk"};
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        switch (mType) {
            ...
            case TYPE_AUDIO:
                ...
                break;
            case TYPE_FILE:
                mLoader = new ApkLoader(context.get());
                break;
        }
    ...
    private void onFileResult(Cursor data) {
        ...
        Log.e("LLLLL_APK: ", String.valueOf(directories.size()));
