package com.bbot.copydata.xender.filter;

import androidx.fragment.app.FragmentActivity;

import com.bbot.copydata.xender.filter.callback.ApkResultCallback;
import com.bbot.copydata.xender.filter.callback.ApkfilecallBack;
import com.bbot.copydata.xender.filter.callback.FileLoaderCallbacks;
...
import static com.bbot.copydata.xender.filter.callback.FileLoaderCallbacks.TYPE_AUDIO;
import static com.bbot.copydata.xender.filter.callback.FileLoaderCallbacks.TYPE_FILE;
import static com.bbot.copydata.xender.filter.callback.FileLoaderCallbacks.TYPE_IMAGE;
import static com.bbot.copydata.xender.filter.callback.FileLoaderCallbacks.TYPE_VIDEO;
