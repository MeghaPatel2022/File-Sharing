package com.bbot.copydata.xender.filter.loader;
...
public class ApkLoader extends CursorLoader {
    ...
    private ApkLoader(Context context, Uri uri, String[] projection, String selection,
